# Generated by Powerlevel10k configuration wizard on 2022-01-06 at 02:59 +07.
...
# sharp tails, 1 line, sparse, fluent, instant_prompt=verbose.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=212
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=270
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=212
  ...
  ######################################[ ram: free RAM ]#######################################
  # RAM color.
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=260
  typeset -g POWERLEVEL9K_RAM_BACKGROUND=68
  # Custom icon.
